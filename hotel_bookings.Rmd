...
After completing the data cleansing process, we save the cleaned dataset to a CSV file 
so it can be used directly in the visualization script (Component 2 of the PAC), ensuring 
consistency between the exploratory analysis and the final visualization:
