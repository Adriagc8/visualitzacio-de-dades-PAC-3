...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="acte" id="acte5">
            ...
            <div class="graph-container" id="graph5b" role="img" aria-label="Histograma que mostra la distribució de canvis a la reserva per origen. Les reserves locals presenten menys canvis que les internacionals."></div>
            <div class="graph-container" id="graph5c" role="img" aria-label="Gràfic de barres apilades que mostra el tipus de dipòsit per origen. Les reserves locals utilitzen més dipòsits Non Refund que les internacionals."></div>
            ...
            <div class="takeaway">
                <strong>Takeaway:</strong> Les reserves locals presenten menys canvis a la reserva i més dipòsits amb compromís que les internacionals, però tot i això cancel·len més. Aquesta paradoxa suggereix que la major cancel·lació no es deu a volatilitat en la reserva, sinó possiblement a altres factors com la proximitat geogràfica.
            </div>
        </div>
